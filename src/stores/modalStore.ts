import { AGENT_EDIT_MODAL, AGENT_PREVIEW_MODAL, APPLICATION_MODAL, APPLICATION_PREVIEW_MODAL, COOKIE_MODAL, EDIT_PROPERTY_MODAL, LOGIN_MODAL, LONG_LOADING_MODAL, PAYMENT_LINK_MODAL, POTENTIAL_SEARCHERS_MODAL, PROMOTE_USERS_MODAL, PROPERTY_LOGS_MODAL, REFERRAL_BONUS_EDIT_MODAL, REFERRAL_BONUS_PREVIEW_MODAL } from "@/utils/defines";
...
const initialValues = {
  ...
  [APPLICATION_PREVIEW_MODAL]: false,
