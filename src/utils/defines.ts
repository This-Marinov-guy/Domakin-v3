...
export const AGENT_EDIT_MODAL = "AGENT_EDIT_MODAL";
export const AGENT_PREVIEW_MODAL = "AGENT_PREVIEW_MODAL";
export const PROPERTY_LOGS_MODAL = "PROPERTY_LOGS_MODAL";
