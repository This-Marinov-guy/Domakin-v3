...
const EditPropertyModal = ({ callback = () => { } }: any) => {
  ...
  const reloadProperties = async () => {
    // NOTE: for some reason the table is updates by itself
    // try {
          ...
          <form className="form-style-one wow fadeInUp">
            <div className="container m-a controls">
              <div className="row mt-20 mb-20">
                {isAdmin && <div className="col-12 mb-4 d-flex flex-column gap-2 align-items-center">
                ...
                {(!!editPropertyData.releaseTimestamp && isAdmin) && (
